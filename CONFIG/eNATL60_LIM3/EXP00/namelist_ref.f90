...
!   !!
!   !! LOLO add:
!   rthr_grad_sst    = 0.00075 ! [K/m] | threshold value from which |grad(SST)| is considered too extreme!!
!   ramp_aht         =  8.0    ! multiplicative factor to ahtu,ahtv to apply where |grad(SST)| == rthr_grad_sst !
